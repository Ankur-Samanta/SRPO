...
LOSS_DIR = SRPO_DIR / "logs" / "srpo_per_token" / "grad_dump_l2n_ep1"
BRANCH_FILE = next((SRPO_DIR / "logs" / "srpo_localizations" / "grad_dump_l2n_ep1").glob("branches_pid*.jsonl"))
OUT_DIR = SRPO_DIR / "figures"
