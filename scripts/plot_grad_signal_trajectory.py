...
CSV_PATH = SCPO_DIR / "scripts" / "grad_dump_analysis_full_out" / "per_step.csv"
FIG_DIR = SCPO_DIR / "figures"
...
def load_per_step() -> list[dict]:
    ...
    pp_path = SCPO_DIR / "scripts" / "grad_dump_analysis_full_out" / "per_prompt.csv"
