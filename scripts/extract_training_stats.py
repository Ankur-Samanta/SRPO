...
NuminaMath-Olympiads ep2 checkpoints (TGRPO / SCGRPO / SCGRPO-Rand x
...
RUNS = {
    ...
    "scgrpo_olmo7b":     "run-20260328_023854-o3j4inwh",
    "scgrpo_rand_olmo7b":"run-20260410_214057-an8ss5yz",
    "tgrpo_olmo7b_s420":       "run-20260415_161907-6ax7m84u",
    "scgrpo_olmo7b_s420":      "run-20260415_162230-7bet0toa",
    "scgrpo_rand_olmo7b_s420": "run-20260415_162140-6zozwlxy",
}
...
def extract_branches(out_dir: Path):
    """Extract per-rollout ICS stats from logs/scgrpo_branches/*.jsonl."""
    import json
    bdir = REPO / "logs" / "scgrpo_branches"
    if not bdir.exists():
