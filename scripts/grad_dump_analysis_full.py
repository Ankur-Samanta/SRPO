...
LOSS_DIR = SRPO_DIR / "logs" / "srpo_per_token" / RUN_NAME
BRANCH_FILE = next((SRPO_DIR / "logs" / "srpo_localizations" / RUN_NAME).glob("branches_pid*.jsonl"))
OUT_DIR = SRPO_DIR / "scripts" / "grad_dump_analysis_full_out"
