...
LOSS_DIR    = SCPO_DIR / "logs" / "srpo_per_token" / "grad_dump_l2n_ep1_v2"
BRANCH_DIR  = SCPO_DIR / "logs" / "srpo_localizations" / "grad_dump_l2n_ep1_v2"
OUT_CSV     = SCPO_DIR / "scripts" / "grad_norm_actual.csv"
BASE_MODEL  = "allenai/OLMo-3-7B-Instruct"
LORA_PATH   = SCPO_DIR / "checkpoints" / "srpo_grad_dump" / "lora_init" / "lora_adapter"
